/* ============================================================
   paises.js — Andes Consultoría (datos, derivado de tropicalize.js)
...
(function () {
  ...
  /* ---------- Cadenas del rediseño editorial ----------
     Titulares y rótulos nuevos de la v1. Frases cortas de interfaz;
     la redacción normativa larga sigue viniendo de la tabla de arriba. */
  var ED = {
    es:{ ed_cta1:"Cotizar un servicio", ed_live:"Trazabilidad en vivo", ed_menu:"Menú", ed_close:"Cerrar",
      ed_idx:"Índice", ed_h1a:"Resultados", ed_h1b:"que se pueden", ed_h1c:"trazar",
      ed_lead:"Consultoría al sector público, productizada. Definimos los insumos, dimensionamos el trabajo y entregamos con seguimiento verificable en cada hito.",
      ed_scroll:"Desliza", ed_stat:"países prestatarios del BID",
      ed_i1:"Introducción", ed_i2:"Servicios", ed_i3:"Cobertura por país", ed_i4:"Proceso",
      ed_i5:"Trazabilidad", ed_i6:"Nosotros", ed_i7:"Preguntas", ed_i8:"Contacto",
      ed_scene_k:"Cómo trabajan los agentes", ed_sc_title:"Servicios",
      ed_pr_title:"Cuatro pasos, sin sorpresas",
      ed_p1:"Cotiza", ed_p1d:"Eliges el servicio, defines los insumos y ves el precio al instante.",
      ed_p2:"Paga", ed_p2d:"Pago en línea seguro, u orden de servicio si eres entidad pública.",
      ed_p3:"Elaboramos", ed_p3d:"Los agentes redactan y un especialista revisa y firma.",
      ed_p4:"Recibe", ed_p4d:"Entrega al correo con código de seguimiento y trazabilidad completa.",
      ed_cov_title:"Un catálogo, veintiséis marcos normativos",
      ed_cov_lead:"Cambia el país y el catálogo se reexpresa: sistema nacional de inversión, símil de IOARR, órgano rector e idioma. La línea BID se mantiene constante.",
      ed_tr_title:"Sabes exactamente dónde está tu pedido",
      ed_tr_lead:"Cada servicio avanza por hitos verificables. Sin llamadas para preguntar cómo va.",
      ed_track:"Consultar", ed_track_ph:"Código de seguimiento (ej. ACI-2048)",
      ed_ab_title:"Quiénes estamos detrás", ed_faq_title:"Preguntas frecuentes", ed_ct_title:"Hablemos de tu caso",
      ed_aware:"Modo consciente" },
    pt:{ ed_cta1:"Cotar um serviço", ed_live:"Rastreabilidade ao vivo", ed_menu:"Menu", ed_close:"Fechar",
      ed_idx:"Índice", ed_h1a:"Resultados", ed_h1b:"que se podem", ed_h1c:"rastrear",
      ed_lead:"Consultoria ao setor público, produtizada. Definimos os insumos, dimensionamos o trabalho e entregamos com acompanhamento verificável em cada marco.",
      ed_scroll:"Role", ed_stat:"países mutuários do BID",
      ed_i1:"Introdução", ed_i2:"Serviços", ed_i3:"Cobertura por país", ed_i4:"Processo",
      ed_i5:"Rastreabilidade", ed_i6:"Sobre nós", ed_i7:"Perguntas", ed_i8:"Contato",
      ed_scene_k:"Como os agentes trabalham", ed_sc_title:"Serviços",
      ed_pr_title:"Quatro passos, sem surpresas",
      ed_p1:"Cote", ed_p1d:"Escolhe o serviço, define os insumos e vê o preço na hora.",
      ed_p2:"Pague", ed_p2d:"Pagamento on-line seguro, ou ordem de serviço se for órgão público.",
      ed_p3:"Elaboramos", ed_p3d:"Os agentes redigem e um especialista revisa e assina.",
      ed_p4:"Receba", ed_p4d:"Entrega por e-mail com código de acompanhamento e rastreabilidade completa.",
      ed_cov_title:"Um catálogo, vinte e seis marcos normativos",
      ed_cov_lead:"Troque o país e o catálogo se reexpressa: sistema nacional de investimento, equivalente de IOARR, órgão gestor e idioma. A linha BID permanece constante.",
      ed_tr_title:"Você sabe exatamente onde está o seu pedido",
      ed_tr_lead:"Cada serviço avança por marcos verificáveis. Sem precisar ligar para perguntar como vai.",
      ed_track:"Consultar", ed_track_ph:"Código de acompanhamento (ex. ACI-2048)",
      ed_ab_title:"Quem está por trás", ed_faq_title:"Perguntas frequentes", ed_ct_title:"Vamos falar do seu caso",
      ed_aware:"Modo consciente" },
    en:{ ed_cta1:"Request a service", ed_live:"Live traceability", ed_menu:"Menu", ed_close:"Close",
      ed_idx:"Index", ed_h1a:"Results", ed_h1b:"you can", ed_h1c:"trace",
      ed_lead:"Public-sector consulting, productized. We define the inputs, size the work and deliver with verifiable tracking at every milestone.",
      ed_scroll:"Scroll", ed_stat:"IDB borrowing countries",
      ed_i1:"Introduction", ed_i2:"Services", ed_i3:"Country coverage", ed_i4:"Process",
      ed_i5:"Traceability", ed_i6:"About us", ed_i7:"Questions", ed_i8:"Contact",
      ed_scene_k:"How the agents work", ed_sc_title:"Services",
      ed_pr_title:"Four steps, no surprises",
      ed_p1:"Quote", ed_p1d:"Pick the service, define the inputs and see the price instantly.",
      ed_p2:"Pay", ed_p2d:"Secure online payment, or a service order if you are a public entity.",
      ed_p3:"We produce", ed_p3d:"Agents draft the work and a specialist reviews and signs it.",
      ed_p4:"Receive", ed_p4d:"Delivered by email with a tracking code and full traceability.",
      ed_cov_title:"One catalogue, twenty-six regulatory frameworks",
      ed_cov_lead:"Switch country and the catalogue re-expresses itself: national investment system, IOARR equivalent, governing body and language. The IDB track stays constant.",
      ed_tr_title:"You know exactly where your order stands",
      ed_tr_lead:"Every service advances through verifiable milestones. No need to call and ask.",
      ed_track:"Check", ed_track_ph:"Tracking code (e.g. ACI-2048)",
      ed_ab_title:"Who is behind this", ed_faq_title:"Frequently asked questions", ed_ct_title:"Let us talk about your case",
      ed_aware:"Mindful mode" },
    fr:{ ed_cta1:"Demander un service", ed_live:"Traçabilité en direct", ed_menu:"Menu", ed_close:"Fermer",
      ed_idx:"Sommaire", ed_h1a:"Des résultats", ed_h1b:"que l'on peut", ed_h1c:"tracer",
      ed_lead:"Conseil au secteur public, produit. Nous définissons les intrants, dimensionnons le travail et livrons avec un suivi vérifiable à chaque jalon.",
      ed_scroll:"Défiler", ed_stat:"pays emprunteurs de la BID",
      ed_i1:"Introduction", ed_i2:"Services", ed_i3:"Couverture par pays", ed_i4:"Processus",
      ed_i5:"Traçabilité", ed_i6:"À propos", ed_i7:"Questions", ed_i8:"Contact",
      ed_scene_k:"Comment travaillent les agents", ed_sc_title:"Services",
      ed_pr_title:"Quatre étapes, sans surprise",
      ed_p1:"Devis", ed_p1d:"Choisissez le service, définissez les intrants et voyez le prix aussitôt.",
      ed_p2:"Paiement", ed_p2d:"Paiement en ligne sécurisé, ou bon de commande si vous êtes une entité publique.",
      ed_p3:"Nous produisons", ed_p3d:"Les agents rédigent et un spécialiste relit et signe.",
      ed_p4:"Réception", ed_p4d:"Livraison par courriel avec code de suivi et traçabilité complète.",
      ed_cov_title:"Un catalogue, vingt-six cadres réglementaires",
      ed_cov_lead:"Changez de pays et le catalogue se reformule : système national d'investissement, équivalent IOARR, organe directeur et langue. Le volet BID reste constant.",
      ed_tr_title:"Vous savez exactement où en est votre commande",
      ed_tr_lead:"Chaque service avance par jalons vérifiables. Sans avoir à appeler pour demander.",
      ed_track:"Consulter", ed_track_ph:"Code de suivi (ex. ACI-2048)",
      ed_ab_title:"Qui est derrière", ed_faq_title:"Questions fréquentes", ed_ct_title:"Parlons de votre cas",
      ed_aware:"Mode sobre" }
  };
  Object.keys(ED).forEach(function (l) {
    I18N[l] = I18N[l] || {};
    Object.keys(ED[l]).forEach(function (k) { I18N[l][k] = ED[l][k]; });
  });

  /* Este módulo solo publica los datos. La capa de interfaz vive en
     editorial.js, que los consume para el selector de país/idioma. */
  window.ANDES_PAISES = { I18N: I18N, C: C, GROUPS: GROUPS };
})();
